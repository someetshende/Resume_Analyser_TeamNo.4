...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='',db='dti')
...
def run():
    ...
    link = '<b>Built with Streamlit by <a href="" style="text-decoration: none; color: #white;">Team No : 4</a></b>' 
    ...
    if choice == 'User':
        ...
        if pdf_file is not None:
            with st.spinner('Hang On While DTI TEAM 4 Does your Magic :'):
                time.sleep(4)
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            ...
            <b>Admin -</b> <br/>
            For login use <b>admin</b> as username and <b>DTI@Team4</b> as password.<br/>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            ## Credentials 
            if ad_user == 'admin' and ad_password == 'DTI@Team4':
                ...
                st.success("Welcome Team 4 ! Total %d " % values + " User's Have Used Our Tool : )")                
